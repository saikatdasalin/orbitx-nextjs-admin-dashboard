      ...
      <div className="w-full max-w-md">
        <div className="bg-card rounded-2xl shadow-xl p-8">
          <div className="text-center mb-8">
            ...
            <p className="text-muted-foreground dark:text-muted-foreground mt-2">Sign in to your account</p>
          </div>
          ...
          <form className="space-y-5">
            ...
            <div className="flex items-center justify-between">
              ...
              <Link href="/auth/forgot-password-1" className="text-sm text-blue-600 hover:text-blue-700">
                Forgot password?
              </Link>
            </div>
          ...
          <div className="mt-6">
            ...
            <div className="mt-6 grid grid-cols-2 gap-3">
              <button className="flex items-center justify-center gap-2 rounded-xl border border-border py-2.5 hover:bg-accent transition-colors">
          ...
          <p className="mt-8 text-center text-sm text-muted-foreground dark:text-muted-foreground">
            ...
            <Link href="/auth/sign-up-1" className="text-blue-600 hover:text-blue-700 font-medium">
              Sign up
            </Link>
          </p>
        </div>
